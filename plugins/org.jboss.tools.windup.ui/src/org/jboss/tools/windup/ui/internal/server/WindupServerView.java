...
import org.jboss.tools.windup.ui.internal.rules.NewXMLFilePage;
import org.jboss.tools.windup.ui.internal.rules.NewXMLRuleHandler;
import org.jboss.tools.windup.ui.internal.rules.RemoveRulesetHandler;
import org.jboss.tools.windup.ui.internal.rules.RuleRepositoryInput;
...
public class WindupServerView extends ViewPart {
	
	public static final String VIEW_ID = "org.jboss.tools.windup.ui.server";
	
	private TreeViewer treeViewer;
	
	private WindupServerContentProvider contentProvider;
	...
	public void createPartControl(Composite parent) {
		...
		menuManager.addMenuListener(new IMenuListener() {
	        public void menuAboutToShow(IMenuManager manager) {
	            WindupServerView.this.fillContextMenu(manager);
	        }
	    });
	...
	private void createSystemRulesTreeViewer(Composite parent) throws RemoteException {
	    ...
	    contentProvider = new WindupServerContentProvider(treeViewer);
