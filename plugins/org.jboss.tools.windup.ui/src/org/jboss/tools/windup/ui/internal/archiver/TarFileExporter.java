...
/**
 * <p>
 * Exports {@link File}s to a .tar or .tar.gz file depending on if compression is enabled or not.
 * </p>
 * 
 * <p>
 * This class is based off of the {@link org.eclipse.ui.internal.wizards.datatransfer.TarFileExporter} class used to archive
...
public class TarFileExporter extends AbstractArchiveFileExporter
{
     ...
     * @param compress <code>true</code> to compress the contents of the TAR using GZip compression, <code>false</code> to not use compression at all
     * 
