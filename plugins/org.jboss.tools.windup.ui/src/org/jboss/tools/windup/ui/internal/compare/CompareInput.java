 ...
 ******************************************************************************/
package org.jboss.tools.windup.ui.internal.compare;
...
/**
 * Compare input for two resources.
 */
public class CompareInput extends CompareEditorInput {
	...
	public String getToolTipText() {
		if (fLeftResource != null && fRightResource != null) {
			...
			String format= org.jboss.tools.windup.ui.internal.Messages.resourceCompareTwoWayTooltip;
