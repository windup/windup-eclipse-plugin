...
import static org.jboss.tools.windup.ui.WindupUIPlugin.IMG_SERVER;
...
public class WindupServerContentProvider implements ITreeContentProvider, ILabelProvider, IStyledLabelProvider {

	private static final Image XML_RULE_PROVIDER;
	private static final Image GROOVY_RULE_PROVIDER;
	
	private static final Image SERVER;
	...
	static {
		...
		SERVER = imageRegistry.get(IMG_SERVER);
	...
	public WindupServerContentProvider (TreeViewer treeViewer) {
	...
	public String getText(Object element) {
		String result = null;
		if (element instanceof WindupServerNode) {
			return Messages.WindupServerLabel;
		}
		else if (element instanceof SystemRulesNode) {
	...
	public Image getImage(Object object) {
		Image image = null;
		if (object instanceof WindupServerNode) {
			image = SERVER;
		}
		else if (object instanceof SystemRulesNode) {
			image = REPOSITORY;
		}
