...
/**
 * <p>
 * Operation for exporting a {@link File} and its children to a new .zip or
 * .tar.gz file.
 * </p>
 * 
 * <p>
 * This class is based off of the
 * {@link org.jboss.tools.windup.core.internal.archiver.ui.internal.wizards.datatransfer.ArchiveFileExportOperation}
 * class used to archive {@link org.eclipse.core.resources.IResource}s, this modified
...
public class ArchiveFileExportOperation implements IRunnableWithProgress {
	 ...
	 *            Files to export
	 * @param archiveName
	 *            Name of archive to export the files too
	 */
	 ...
	 * <p>
	 * Create an instance of this class. Use this constructor if you wish to
	 * recursively export a single resource and all of its descendants.
	 * </p>
	 * 
	 * @param file
	 *            The root file to recursively export to an archive.
	 * @param archiveName
	 *            Name of archive to export the file and its descendants to
	 */
	 ...
	 * 
	 * @param parentFile
	 *            Parent file of all of the files to export to the archive
	 * @param filesToExport
	 *            {@link List} of files to export to the archive using the given
	 *            parent file as the root file
	 * @param archiveName
	 *            Name of the archive to export the files to
	 */
	 ...
	 *             this can happen when performing file IO
	 */
	...
	/**
	 * Creates and returns the string that should be used as the name of the
	 * entry in the archive.
	 * 
	 * @param fileToExport
	 *            {@link File} to to export
	 * @param leadupDepth
	 ...
	 *            {@link File} to export
	 * @param leadupDepth
	 *            the number of directory levels to be included in the path
	 *            including the {@link File} itself.
	 */
	private void exportResource(File fileToExport, IPath relativeTo)
			throws InterruptedException {
		
		if (fileToExport.exists()) {
			/* if the File to export is a file export it
			 * else if File is a directory recursivly export all of it's childre */
	...
	/**
	 * <p>
	 * Export the files contained in the previously-defined
	 * filesToExport collection
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Answer a boolean indicating whether the passed child is a descendant of
	 * one or more members of the passed resources collection
	 * </p>
	 * 
	 * @param parentFiles
	 *            Check if the given child is a child of any of these parent
	 *            files
	 * @param child
	 *            Check if this child is a child of any of the given parent
	 *            files
	 * 
	 * @return <code>true</code> if the given file is a descendant of any of the
	 *         given parent files, <code>false</code> otherwise
	 */
