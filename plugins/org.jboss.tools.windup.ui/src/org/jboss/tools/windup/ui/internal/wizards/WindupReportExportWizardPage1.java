...
public class WindupReportExportWizardPage1 extends WizardPage implements Listener, IOverwriteQuery {
	 ...
	 * 
	 * @param selection
	 *            Current selection to determine the default projects to export
	 *            reports for
	 */
	 ...
	 * </p>
	 * 
	 * @returns boolean <code>true</code> if successfully finished,
	...
	public boolean finish() {
		...
		/* convert the list of selected projects into a list of
		 * Windup reports for those selected projects */
		...
		for (IProject selectedProject : selectedProjects) {
			...
			/* if regenerating all windup reports or
			 * windup report does not exist for project
			 * add it to the list of projects to create windup reports for */
	...
	/**
	 * <p>
	 * Generates reports for any of the given projects that need reports
	 * generated. Then exports all of the given report parent directories.
	 * </p>
	 * 
	 * @param reportParentDirectories
	 *            parent report directories to export
	 * @param projectsWithoutReports
	 *            projects that need Windup reports generated before the export
	 * 
	 * @return <code>true</code> if the export is a success, <code>false</code>
	 *         otherwise
	 */
	private boolean executeExportOperation(
		...
		/* if there are projects that need a windup report generated
		 * create an operation to do that */
		...
		try {
			 ...
			 * then export all selected reports */
