...
/**
 * <p>
 * Defines an abstract {@link IFileExporter} which uses the Apache commons
 * archivers API to perform archive export operations.
 * </p>
 */
public abstract class AbstractArchiveFileExporter implements IFileExporter {
	 ...
	 * @param compress
	 *            <code>true</code> to use compression when creating the ZIP
	...
	/**
	 * @see org.jboss.tools.windup.ui.internal.archiver.IFileExporter#write(java.io.File,
	 *      java.lang.String)
	 */
	@Override
	public final void write(File fileToArchive, String destinationPath)
		...
		/* if file, add it's contents to the archive
		 * else if directory close the new entry  */
	...
	/**
	 * <p>
	 * Closes the output stream returned by
	 * {@link #createOutputStream(String, boolean)}.
	 * </p>
	 * 
	 * <p>
	 * If subclasses overrides this method then it needs to be sure to call the
	 ...
	 * 
	 * @throws IOException
	 *             this can happen during file IO
	 */
	...
	/**
	 * <p>
	 * Creates and returns a new {@link ArchiveEntry} based on the given
	 * information.
	 * </p>
	 * 
	 * @param fileToArchive
	 *            {@link File} to archive to the given destination in the
	 *            archive
	 * @param destinationPath
	 *            destination to archive the given {@link File} in the archive
	 * 
	 * @return a new {@link ArchiveEntry} for the given file to archive to the
	 *         given destination
	 */
