...
public interface IFileExporter {
     ...
     * 
     * <p>
     * If the given file is a {@link File} write the file to the archive, else if
     * the {@link File} is a directory write an entry for the directory's name to
     * the archive.
     * </p>
     * 
     * @param fileToArchive   {@link File} to write to the archive
     * @param destinationPath destination within the archive to write the given
     *                        {@link File} to
     * 
     * @throws IOException Can happen when performing file IO
     */
